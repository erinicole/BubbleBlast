      ...
      <div className="footer">
          <div className="footer-person">
            ...
            <div className="footer-icons">
              <a href="https://github.com/erinicole"> <img className="github-logo" src="/assets/images/github-white.png"></img></a>
              <a href="https://www.linkedin.com/in/erinicole1988/"> <img className="github-logo" src="/assets/images/linkedin-white.png"></img></a>
            </div>
          </div>
          <div className="footer-person">
            <h1 className="footer-name">Kristina Miller</h1>
            <div className="footer-icons">
              <a href="https://github.com/kristinamiller"> <img className="github-logo" src="/assets/images/github-white.png"></img></a>
              <a href="https://www.linkedin.com/in/kristinafmiller/"> <img className="github-logo" src="/assets/images/linkedin-white.png"></img></a>
            </div>
          </div>
